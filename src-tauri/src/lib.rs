...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::flashcards_create_manual,
            commands::flashcards_create_from_notes,
            commands::flashcards_list,
            commands::flashcards_get,
            commands::flashcards_update,
            commands::flashcards_review_next,
            commands::flashcards_submit_review,
            commands::dashboard_get_overview,
            commands::projects_get_state,
            commands::projects_list_details,
            commands::projects_assign_notes,
            commands::projects_task_create,
            commands::projects_task_update,
            commands::projects_task_delete,
            commands::habits_list,
            commands::habits_create,
            commands::habits_update,
            commands::habits_archive,
            commands::habits_delete,
